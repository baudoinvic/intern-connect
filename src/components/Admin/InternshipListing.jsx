...
//                       <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">TechCorp Inc.</td>
//                       <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">San Francisco, CA</td>
