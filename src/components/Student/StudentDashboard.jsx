...
//   const studentInfo = {
//     name: "William",
//     image: "../../assets/images/DSC_1168.JPG" // Replace with actual image path
//   };
...
//         <div className="p-8">
//           <h2 className="text-2xl font-semibold text-gray-800 mb-6">Your Dashboard</h2>
...
//                       <p className="text-lg font-bold text-gray-900 mt-1">{card.status}</p>
//                     </div>
//                   </div>
...
//                     <div className={`w-10 h-10 rounded-full bg-${activity.color.split('-')[1]}-100 flex items-center justify-center ${activity.color}`}>
//                       {activity.icon}
//                     </div>
...
//   const studentInfo = {
//     name: "William",
//     // Remove the image path from here since we're importing it
//     image: profileImage
//   };
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-4 md:p-8">
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-6">Your Dashboard</h2>
              ...
              <div key={index} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
                <div className="p-4 md:p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-600">{card.title}</p>
                      <p className="text-base md:text-lg font-bold text-gray-900 mt-1">{card.status}</p>
                    </div>
                  </div>
                  <p className="text-xs md:text-sm text-gray-500">{card.details}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md mt-6">
            <div className="p-4 md:p-6">
              ...
              <div className="space-y-4">
                {recentActivity.map((activity, index) => (
                  <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center p-4 bg-gray-50 rounded-lg">
                    <div className={`w-10 h-10 rounded-full bg-${activity.color.split('-')[1]}-100 flex items-center justify-center ${activity.color} mb-2 sm:mb-0`}>
                      {activity.icon}
                    </div>
                    ...
                    <span className="text-xs text-gray-400 mt-2 sm:mt-0">{activity.time}</span>
                  </div>
                ))}
              </div>
            </div>
